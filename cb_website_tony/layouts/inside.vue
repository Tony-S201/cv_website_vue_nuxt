...
<!-- TEST -->
      ...
      <!-- <svg preserveAspectRatio="xMidYMax meet" class="svg-separator sep8 inside-divider" viewBox="0 0 1600 200" style="display: block;" data-height="200">
        ...
        <path class="" style="fill: rgb(52, 46, 55);" d="M1475.4,177c0,0-16.4-8.1-30.8-35.3c6,0.6,12.1,1.2,18.1,1.8
